<?php
namespace Gdo\CustomContactForm\Controller\Contact;
...
class Index extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        if( isset($post['last-name']) && $post['last-name'] ){
            $requestData['last-name'] = $post['last-name'];
        }
        ...
        if( isset($post['company']) && $post['company'] ){
            $requestData['company'] = $post['company'];
        }
         if( isset($post['department']) && $post['department'] ){
            $requestData['department'] = $post['department'];
        }
